  ...
  this.loop(function(end) {
    ...
    this.uint8("pid").tap(function() {
      ...
      switch (this.vars.pid) {
        ...
        case 0x10: this.int16be("item"); break;
        case 0x1b: this.uint8("sideways").uint8("forward").uint8("jump").uint8("unmount"); break;
        ...
        case 0x13: this.uint32be("eid").uint8("action").uint32be("jumpBoost"); break;
